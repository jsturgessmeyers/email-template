...
(function parseEmail(filePath) {
  ...
  var banner = cleanText($('#bannerSection').text());
  var disclosure = cleanText($('.disclosure').text());
  var noreply = cleanText($('.noreply').text());
  var unsub = cleanText($('.unsub').text());
  var unsubURL = '>> ' + $('a[name="unsub"]').attr('href');
  var noreplyURL = '>> ' + $('a[name="noreply"]').attr('href');
  var address = cleanText($('.address').text());

  var pubName = cleanText($('#logo').attr('alt'));
  var pubURL = '>> ' + $('a[name="pubURL"]').attr('href');

  // Function to cleanse text
  // First removes formatting
